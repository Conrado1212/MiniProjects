...
let re3 = /c.t/;
console.log(re3.exec("haircut")); // -> ["cut", index: 4, input: "haircut", groups: undefined]
console.log(re3.exec("ct")); // -> null


// String -> match, search, replace, ...
let re4 = /c.t/;
let str = "dog and cat";
console.log(str.match(re4)); // -> ["cat", index: 8, input: "dog and cat", groups: undefined]
console.log(str.search(re4)); // -> 8
console.log(str.replace(re4, 'unicorn')); // -> dog and unicorn
