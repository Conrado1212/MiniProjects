...
//  Declare an array of objects that will correspond to the following images: Mona Lisa (Leonardo da Vinci, 1503), 
//  The Last Supper (Leonardo da Vinci, 1495), Starry Night (Vincent van Gogh, 1889), The Scream (Edvard Munch, 1893),
//   Guernica (Pablo Picasso, 1937), The Kiss (Gustav Klimt, 1907), Girl With a Pearl Earring (Johannes Vermeer, 1665), 
...
console.log("Title: "+images[i].title + " artist: " + images[i].artist + " date of creation: " + images[i].date);
}
